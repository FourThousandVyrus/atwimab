...
* DO NOT introduce online banking functionality
* DO NOT add mobile banking systems
* DO NOT redesign the brand identity
* DO NOT drastically alter layouts already approved
* Suggestions should be additive and enhancement-focused only
...
* Add subtle banking-inspired gradients
